    ...
    ApplicationListener<ApplicationReadyEvent> ready(RetroBoardService retroBoardService) {
        return applicationReadyEvent -> {
            ...
            RetroBoard retroBoard = RetroBoard.builder()
                    ...
                    .card(
                            UUID.fromString("bb2a80a5-a0f5-4180-a6dc-80c84bc014c9"),
                            Card.builder()
                    ...
                    .card(
                            UUID.fromString("f9de7f11-5393-4b5b-8e9d-10eca5f50189"),
                            Card.builder()
                                    .id(UUID.randomUUID())
                    ...
                    .card(
                            UUID.fromString("6cdb30d6-43f2-42b7-b0db-f3acbc53d467"),
                            Card.builder()
                                    .id(UUID.randomUUID())
                    ...
                    .card(
                            UUID.fromString("9de1f7f9-2470-4c8d-86f2-371203620fcd"),
                            Card.builder()
                                    .id(UUID.randomUUID())
